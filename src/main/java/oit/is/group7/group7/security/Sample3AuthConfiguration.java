package oit.is.group7.group7.security;
...
public class Sample3AuthConfiguration extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(AuthenticationManagerBuilder auth) throws Exception {
    ...
    auth.inMemoryAuthentication().withUser("z1438")
        .password("$2y$10$0CoGn4wWW4ggugN9FqB00epw6y7TV7cUEWPsjqJWUWMT1Y0NjNQSu").roles("USER");
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    // http://localhost:8080/ で始まるURLへのアクセスはログインが必要
